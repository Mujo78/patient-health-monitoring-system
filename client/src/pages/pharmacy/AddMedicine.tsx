                ...
                <div className='flex justify-between w-full items-center'>
                  <div className='relative flex-grow w-2/3'>
                    ...
                    <Tooltip
                      ...
                      placement='right'
                      content={selectedImg && img ? 
                        <div>
                          <HiXCircle className="text-red-600 ml-auto h-[20px] w-[20px] cursor-pointer hover:w-[23px] hover:h-[23px] mt-1 hover:transition-all hover:duration-300" onClick={handleDelete} />
                          <img src={img} className='w-[180px]' alt="Selected Image" />
                        </div> : ""}
                      className='w-1/7'
                    >
