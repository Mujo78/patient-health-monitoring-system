    ...
    <>
      <Card className="w-1/4" href={`/profile/ph/${data.pharmacy._id}`}>
        <div className="flex flex-col gap-7">
          ...
          <div>
            <p>Working hours:</p>
            <p className="text-gray-400 mt-2 text-xl text-center">
      ...
      <div className="flex w-1/3 gap-5 justify-between">
        <div className="flex flex-col w-full justify-around">
          <Card className="max-w-xs">
            ...
            <h1 className="text-4xl mx-auto font-semi-bold text-green-500 my-auto">
              {data.total.total_number}
            </h1>
          </Card>
          <Card className="max-w-xs">
            <p className="text-center text-sm">Total available</p>
            <h1 className="text-4xl mx-auto text-green-500 font-semi-bold my-auto">
        ...
        <div className="flex flex-col w-full justify-around">
          ...
          <Card className="max-w-xs">
            ...
            <h1 className="text-4xl mx-auto text-red-600 font-semi-bold my-auto">
            ...
            <div className="divide-y mt-3">
              {data.recentMedicine.map((m) => (
                <Link
                  to={`/medicine/${m._id}`}
                  key={m._id}
                  className="flex gap-3 items-center p-4 transition-all duration-100 hover:bg-gray-100 cursor-pointer"
                >
                  <CustomMedicineImg
                    url={
