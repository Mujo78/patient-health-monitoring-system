...
import { Department, getDepartments } from '../../../service/departmentSideFunctions'
        ...
        <div className=' w-1/3'>
          ...
          <Table className='mt-2'>
            <Table.Body className="divide-y">
              {departments &&
                departments.map((n) => (
                <Table.Row onClick={() => chooseDepartment(n.name)} key={n._id} className={`bg-white cursor-pointer dark:border-gray-700 ${departmentName === n.name && 'bg-blue-200'} dark:bg-gray-800`}>
