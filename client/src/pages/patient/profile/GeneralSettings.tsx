...
import { updateUser, authUser, deactivateAccount, logout, reset } from '../../../features/auth/authSlice'
...
import { generalPatientSettings, patientGeneralSettings } from '../../../validations/personValidation'
...
const GeneralSettings: React.FC = () => {
    ...
    const { register, handleSubmit,control, formState, reset: resetForm} = useForm<patientGeneralSettings>({resolver: yupResolver(generalPatientSettings)})
    ...
    <div className='flex flex-col h-full'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col justify-between h-full'>
                        ...
                        <div>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <div className='flex flex-col w-3/5'>
                                    ...
                                    <ErrorMessage text={errors.email?.message ? errors.email.message : errorMessage?.includes("email") ? errorMessageConvert(errorMessage, "email"): ""} className='text-xs mt-1' />
                                </div>
                            </div>
                            <div className='flex items-center mt-3 justify-between'>
                                ...
                                />
                                <Controller control={control} name="notification" render={({ field: {value, onChange } }) => 
                                    <ToggleSwitch label="" color='success' checked={value} onChange={onChange} />}
                                />
                            </div>
            ...
            <Footer variant={1}>
                <CustomButton size='sm' disabled={!isDirty} className='mt-3' type='submit'>
                    Save changes
                </CustomButton>
            </Footer>
        </form>
