...
const Notification: React.FC = () => {
  ...
  return (
    <div className='w-full flex flex-col font-Poppins justify-between h-full'>
        <div className='flex justify-center flex-col items-center h-full gap-3'>
            {oneNotification?.name.startsWith('Welcome to the') ? 
                <div className='flex flex-col justify-center items-center gap-4'>
                    ...
                    <h2 className='text-lg font-bold text-blue-700'>{oneNotification.name}</h2>
                    <div className='flex flex-col w-2/3 gap-3'>
                        <p className='text-xs text-gray-600 text-justify '>
                            Welcome to the Patient Health Monitoring System! 🏥 We're delighted to have you here. Your health and well-being are our top priorities. Our platform is designed to help you stay informed about your health, connect with healthcare professionals, and track your progress.
                            If you have any questions about using our system or need assistance with anything, don't hesitate to reach out. Our team is here to support you on your health journey. Stay healthy and stay connected
                        </p>
        ...
        <Footer variant={1}>
            <Button onClick={deleteOne} color='failure' size='xs' className='mr-3 mt-2'>
                Delete Notification
            </Button>
        </Footer>
    </div>
