...
import { MakeAppointmentData, editObject, finishAppointmentObj } from "./appointmentSlice"
...
const finishAppointment = async (id: string, finishAppointmentObj: finishAppointmentObj,  token: string) => {
