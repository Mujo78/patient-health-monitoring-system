...
import MyPatients from "./pages/doctor/patient/MyPatients";
import MyDepartment from "./pages/doctor/department/MyDepartment";
...
import PatientProfile from "./components/Patient/PatientProfileNav";
import DoctorProfile from "./components/Doctor/DoctorProfileNav";
import PharmacyProfile from "./components/Pharmacy/PharmacyProfileNav";
