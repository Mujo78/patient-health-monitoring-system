...
const DepartmentAppointmentStatistics: React.FC<Props> = ({
  ...
  return (
    <div className="mt-auto flex h-fit w-full flex-wrap gap-4 pb-20 md:pb-0 xl:!flex-nowrap xxl:!h-2/4 xxl:!text-lg">
      <Card className="h-96 w-full text-xs xl:!w-3/4 xxl:!h-auto xxl:p-2 xxl:!text-lg">
      ...
      <Card className="h-96 w-full xl:!w-1/4 xxl:!h-auto">
